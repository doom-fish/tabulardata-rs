...
| --- | --- | --- |
| `ColumnData::{Strings, Ints, Int32s, Floats, Doubles, Bools, Dates, Data}` | ✅ | Typed column construction and schema-preserving mutation. |
