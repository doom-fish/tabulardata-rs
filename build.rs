...
fn main() {
    ...
    println!("cargo:rustc-link-lib=framework=TabularData");
    ...
    let swift_triple = match target_arch.as_str() {
        ...
        other => panic!("tabulardata-rs: unsupported target arch '{other}'"),
    };
    ...
    println!("cargo:rustc-link-lib=static=TabularDataBridge");
